...
class DataLoader_Train_ST(Sequence):
    ...
    def __init__(self,segment_size):
        self.batch_size = 12
        self.video_path_normal = './data/Normal_Train_ST.txt'
        self.video_path_anomaly ='./data/Anomaly_Train_ST.txt'
        ...
        self.path_frame_feature='./data/I3D_ST'   ############ IMAGE NET + KINETICS FEATURE
        self.segment_size = segment_size
